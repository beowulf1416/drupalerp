...
add constraint fk_erp_acct_hierarchy_1 foreign key (client_id) references erp_clients(id),
add constraint fk_erp_acct_hierarchy_2 foreign key (parent_acct_id) references erp_accounts(id),
add constraint fk_erp_acct_hierarchy_3 foreign key (account_id) references erp_accounts(id);
